                ...
                <div className="p-4 sm:p-6">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-base sm:text-lg text-gray-800 font-normal">No. Of Leads</span>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        ...
                        <div className="flex rounded overflow-hidden shadow-sm">
                            <button
                                ...
                                className={`px-6 sm:px-10 py-2 text-sm sm:text-base font-normal transition-colors ${viewMode === 'month'
                            ...
                            <button
                                ...
                                className={`px-6 sm:px-10 py-2 text-sm sm:text-base font-normal transition-colors ${viewMode === 'week'
                                    ? 'bg-[#14b8a6] text-white'
                                    : 'bg-[#14b8a6] text-white opacity-70 hover:opacity-100'
                                    }`}
                            >
                            ...
                            <div className="grid grid-cols-7">
                                {days.map((dayInfo, index) => {
                                    ...
                                    return (
                                        <div
                                            key={index}
                                            className={`min-h-[80px] sm:min-h-[120px] lg:min-h-[140px] border-b border-gray-300 p-2 sm:p-3 ${!isLastColumn ? 'border-r border-gray-300' : ''
                                            ...
                                            <div className="flex flex-col h-full">
                                                <div className="text-left">
                                                    {today ? (
                                                        ...
                                                        <span
                                                            className={`text-sm sm:text-base font-normal ${!dayInfo.isCurrentMonth
                                                                ? 'text-gray-400'
                                                                : 'text-gray-700'
                                                                }`}
                                                        >
