...
export default function EmailSection() {
  ...
  const [templates, setTemplates] = useState([
    { id: "default-1", name: "Follow-up Template", content: "<p>Hello, this is a follow-up email.</p>",
      isCustom: false }
  ]);
  ...
  const saveTemplate = () => {
    ...
    setTemplates([templates[0], ...updatedTemplates]);
  ...
  return (
    <div className="w-full min-h-screen bg-gray-50 overflow-y-auto pb-30">
      <style>{`
        @keyframes slideDown {
          from {
            opacity: 0;
...
//               ) : (
//                 emailLogs.map((log) => (
//                   <div key={log.id} className="border border-gray-300 rounded-lg p-4 bg-white shadow-sm hover:shadow-md transition-shadow">
//                     <div className="space-y-3">
//                       <div className="flex justify-between items-start gap-3">
//                         <div className="flex-1 min-w-0">
//                           <div className="text-xs font-medium text-gray-500 mb-1">To:</div>
