...
export default function FromEmailList() {
    ...
    const emailData = [
        ...
        { id: 3, name: "Parth", email: "Parth@gmail.com" }
    ];
    ...
    return (
        <div className="w-full min-h-screen bg-[#e5e7eb] py-10">
            <div className="max-w-[1480px] max-auto mt-4 px-4">
                            ...
                            <table className="w-full border-collapse">
                                <thead>
                                    <tr className="bg-[#dee2e6]">
                                        ...
                                        <th className="py-3 px-10 text-right text-xs font-semibold text-[#6c757d] uppercase tracking-wider">
                                            DELETE
                                        </th>
                                    </tr>
                                </thead>
