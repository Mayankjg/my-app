...
export default function ImportContacts(){
    ...
    const ImportContactsPage = () => {
        ...
        const handleDownload = () => {
            ...
            const blob = new Blob([csvContant], {type: 'text/csv'});
            const url = window.URL.createObjectURL(blob);
            const link = document.createElement("a");
            link.href = url;
            link.download = 'contacts_template.csv';
                    ...
                    <div className="px-8 py-8">
                        <div className="flex gap-8 mb-8">
                            ...
                            <div className="flex-1">
                                ...
                                className="bg-teal-500 text-white px-6 py-2 rounded text-sm font-medium hover:bg-teal-600 transaction-colors cursor-pointer shadow-sm"
                                >
                                    Download sample
                                </button>
                            </div>
